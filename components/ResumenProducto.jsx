    ...
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
        ...
        <div className="md:w-4/6">
            ...
            <p className="text-xl font-bold text-amber-500 mt-2">
                Precio: {formatearDinero(pedido.precio)}
            </p>
            <p className="text-sm text-gray-700 font-bold mt-2">
                Subtotal: {formatearDinero(pedido.precio * pedido.cantidad)}
            </p>
        </div>
        ...
        <div>
            ...
            <button
                type="button"
                className="mt-3 bg-red-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full "
